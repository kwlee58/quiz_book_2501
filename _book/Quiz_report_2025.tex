...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 11 & 10 & 6 & 4 & 6 & 9 & 34 & 20 & 16 & 10 & 26 & 18 & 26 \\
\textbf{Black} & 14 & 8 & 3 & 3 & 7 & 11 & 47 & 16 & 14 & 15 & 14 & 21 & 25 \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(랜덤화출석부)} & 131 & 2 \\
\textbf{Black(랜덤화출석부)} & 0 & 147 \\
\textbf{계} & 131 & 149 \\
\end{longtable}
...
Red 로 응답한 인원은 131명, Black 에 응답한 인원은 149명입니다.

전체 응답인원 280 명을 랜덤하게 둘로 나눌 때 어느 한 쪽의 기대인원은 전체 응답인원의 절반인 140명이고, 표준오차는 전체 응답인원의 제곱근에 1/2을 곱해 준 8.4 명입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 99 & 2 & 3 & 28 & 132 \\
\textbf{Black} & 113 & 5 & 2 & 29 & 149 \\
\textbf{계} & 212 & 7 & 5 & 57 & 281 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 1.40, 자유도는 3 , p-value 는 0.70이므로 Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
75.4 & 2.5 & 1.8 & 20.3 & 100.0 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 75.4(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 91 & 17 & 22 & 2 & 132 \\
\textbf{Black} & 102 & 14 & 25 & 8 & 149 \\
\textbf{계} & 193 & 31 & 47 & 10 & 281 \\
\end{longtable}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 10 & 97 & 20 & 5 & 132 \\
\textbf{Black} & 14 & 97 & 34 & 4 & 149 \\
\textbf{계} & 24 & 194 & 54 & 9 & 281 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 3.39, 자유도는 3, p-value 는 0.34이므로 Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 93 & 15 & 14 & 10 & 132 \\
\textbf{Black} & 115 & 11 & 6 & 17 & 149 \\
\textbf{계} & 208 & 26 & 20 & 27 & 281 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 6.95, 자유도는 3, p-value 는 0.073이므로 Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 23 & 89 & 14 & 6 & 132 \\
\textbf{Black} & 37 & 95 & 15 & 2 & 149 \\
\textbf{계} & 60 & 184 & 29 & 8 & 281 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 4.48, 자유도는 3, p-value 는 0.21이므로 Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
21.4 & 65.5 & 10.3 & 2.8 & 100.0 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 65.5(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 7 & 29 & 19 & 77 & 132 \\
\textbf{Black} & 5 & 41 & 21 & 82 & 149 \\
\textbf{계} & 12 & 70 & 40 & 159 & 281 \\
\end{longtable}
...
그 결과 카이제곱 통계량은 1.63, 자유도는 3, p-value 는 0.65이므로 Red, Black 간에 통계적으로 유의한 차이를 보이지 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
4.3 & 24.9 & 14.2 & 56.6 & 100.0 \\
\end{longtable}

정답률은 Red, Black 을 합하여 계산하는데, 56.6(\%) 입니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(추상적 질문)} & 45 & 87 & 132 \\
\textbf{Black(구체적 질문)} & 92 & 57 & 149 \\
\textbf{계} & 137 & 144 & 281 \\
\end{longtable}
...
Red의 경우 총 132(명)이 응답하였고 45(명)이 정답인 \{A, 3\}를 올렸습니다.

구체적인 상황에 놓인 Black의 경우 총 149(명)이 응답하였고 92(명)이 정답인 \{Beer,17\}을 올려서 구체적인 질문에 압도적으로 많은 정답이 나온 것을 알 수 있습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(추상적 질문)} & 34.1 & 65.9 & 100.0 \\
\textbf{Black(구체적 질문)} & 61.7 & 38.3 & 100.0 \\
\end{longtable}

추상적인 질문으로 이루어진 Red에서는 34.1(\%)가 정답을 올렸고, 구체적인 질문으로 이루어진 Black에서는 61.7(\%)가 정답을 올려서 구체적인 질문에 압도적으로 많은 정답이 올라왔다는 것을 알 수 있습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(구체적 질문)} & 79 & 53 & 132 \\
\textbf{Black(추상적 질문)} & 40 & 109 & 149 \\
\textbf{계} & 119 & 162 & 281 \\
\end{longtable}

구체적인 질문을 배치한 Red의 경우 총 132(명)이 응답하였고 79(명)이 정답인 \{Beer, 17\}(을)를 올렸습니다.

추상적인 질문을 배치한 Black의 경우 총 149(명)이 응답하였고 40(명)이 정답인 \{A,3\}(을)를 올려서 구체적인 질문에 압도적으로 많은 정답이 나온 것을 알 수 있습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(구체적 질문)} & 59.8 & 40.2 & 100.0 \\
\textbf{Black(추상적 질문)} & 26.8 & 73.2 & 100.0 \\
\end{longtable}

구체적인 질문을 배치한 Red에서는 59.8(\%)가 정답을 올렸고, 추상적인 질문을 배치한 Black에서는 26.8(\%)가 정답을 올려서 구체적인 질문에 압도적으로 많은 정답이 올라왔다는 것을 알 수 있습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(추상적 질문 먼저)} & 49 & 41 & 42 & 132 \\
\textbf{Black(구체적 질문 먼저)} & 72 & 35 & 42 & 149 \\
\textbf{계} & 121 & 76 & 84 & 281 \\
\end{longtable}
...
추상적 질문이 먼저 Q7에 나온 Red의 경우 총 132(명)이 응답하였고 49(명)이 확증편향에서 비롯된 \{A,2\}를 올렸습니다.

정답인 \{A,3\}를 올린 41(명)보다 훨씬 많습니다.

추상적 질문이 Q8에 나온 Black 의 경우 총 149(명)이 응답하였고 72(명)이 확증편향에서 비롯된 \{A,2\}를 올렸습니다.

정답인 \{A,3\}를 올린 35(명)보다 훨씬 많습니다.

합해서 121(명)이 확증편향에서 비롯된 \{A,2\}를 올렸고, 76(명)이 정답인 \{A,3\}를 올렸습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(추상적 질문 먼저)} & 37.1 & 31.1 & 31.8 & 100.0 \\
\textbf{Black(구체적 질문 먼저)} & 48.3 & 23.5 & 28.2 & 100.0 \\
\textbf{계} & 43.1 & 27.0 & 29.9 & 100.0 \\
\end{longtable}

추상적인 질문이 먼저 Q7에 나온 Red에서는 37.1(\%)가 확증편향에서 비롯된 응답 \{A,2\}를 올렸고, 31.1(\%)가 정답인 \{A,3\}을 올렸는데, 추상적인 질문이 나중에 Q8에 나온 Black 에서는 48.3(\%)가 확증편향에서 비롯된 응답 \{A,2\}를 올렸고, 23.5(\%)가 정답인 \{A,3\}을 올렸습니다.

합해서 보면 43.1(\%)가 확증편향에서 비롯된 응답 \{A,2\}를 올렸고, 27.0(\%)가 정답인 \{A,3\}을 올렸습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(추상적 질문 먼저)} & 45 & 79 & 124 \\
\textbf{Black(구체적 질문 먼저)} & 40 & 92 & 132 \\
\end{longtable}
...
추상적 질문을 Q7에 배치하고 구체적 질문을 Q8에 배치한 Red의 경우 추상적 질문과 구체적 질문에 정답을 올린 사람은 총 124(명)이고 구체적 질문을 Q7에 배치하고 추상적 질문을 Q8에 배치한 Black의 경우 추상적 질문과 구체적 질문에 정답을 올린 사람은 총 132(명)으로 별로 차이가 나지 않습니다.

추상적 질문을 Q8에 배치한 Black 의 경우 40(명) 이 정답을 올려서 추상적 질문을 먼저 학습한 경우 정답을 더 많이 내었지만 통계적으로 유의한 차이는 아닌 것으로 나타나고 있습니다.

카이제곱 통계량은 0.78, p-value 는 0.38으로 통계적으로 유의한 차이를 관찰하지 못하였습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red(추상적 질문 먼저)} & 52.9 & 46.2 \\
\textbf{Black(구체적 질문 먼저)} & 47.1 & 53.8 \\
\textbf{계} & 100.0 & 100.0 \\
\end{longtable}

추상적 질문에 대한 Red, Black 간 정답률 차이와 구체적 질문에 대한 Red, Black 간 정답률 차이를 비교하였습니다.

추상적 질문에 대한 전체 정답 중에서 추상적 질문을 먼저 제시한 Red 가 52.9(\%)를 차지하여 추상적 질문을 나중에 제시한 Black 보다 높습니다만 그 차이는 앞에서 살펴 본 것처럼 통계적으로 유의하지는 않습니다.
...
\bottomrule\noalign{}
\endlastfoot
\textbf{추상적 문제} & 85 & 196 & 281 \\
\textbf{구체적 문제} & 171 & 110 & 281 \\
\end{longtable}

추상적 질문에 답한 사람 총 281(명) 중에 정답을 올린 사람은 모두 85(명)이고 구체적 질문에 답한 사람 총 281(명) 중에 정답을 올린 사람은 모두 171(명)입니다. 백분율로 비교해 보면
...
\bottomrule\noalign{}
\endlastfoot
\textbf{추상적 문제} & 30.2 & 69.8 & 100.0 \\
\textbf{구체적 문제} & 60.9 & 39.1 & 100.0 \\
\end{longtable}

추상적 질문에 정답을 올린 사람의 백분율은 30.2(\%)이고 구체적 질문에 정답을 올린 사람의 백분율은 30.2(\%)입니다.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0863}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0576}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0647}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0719}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0719}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0719}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0719}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0432}}@{}}
\caption{일 단위}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
~
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Red} & 0 & 0 & 0 & 5 & 1 & 0 & 1 & 25 & 14 & 16 & 12 & 16 & 18 & 24 & 132 \\
\textbf{Black} & 0 & 0 & 0 & 1 & 3 & 3 & 7 & 35 & 13 & 14 & 11 & 14 & 16 & 32 & 149 \\
\textbf{계} & 0 & 0 & 0 & 6 & 4 & 3 & 8 & 60 & 27 & 30 & 23 & 30 & 34 & 56 & 281 \\
\end{longtable}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0797}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0580}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0652}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0725}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0725}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0725}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0725}}
  >{\centering\arraybackslash}p{(\columnwidth - 30\tabcolsep) * \real{0.0435}}@{}}
\caption{일 단위}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
~
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0833}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0606}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0682}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0758}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0758}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0758}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0758}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0661}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0744}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0826}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0826}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0826}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.0826}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0902}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0602}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0677}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0752}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0752}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0752}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 28\tabcolsep) * \real{0.0752}}@{}}
\toprule\noalign{}
